...
/**
 * struct liststr - linked list (singly)
 * @num: integer num
 * @str: pounter to string
...
/**
 *struct builtin - builtin commands and their associated functions
 *@type: command flag
 *@func: the function
 */
...
ssize_t read_line(info_t *);
int get_line(info_t *, char **, size_t *);
void sig_num_handler(int);
...
int yes_chain(info_t *, char *, size_t *);
void read_chain(info_t *, char *, size_t *, size_t, size_t);
int replace_alias(info_t *);
int replace_vars(info_t *);
int replace_string(char **, char *);

int _myunsetenv(info_t *);
int get_env_list(info_t *);
...
int all_history_list(info_t *info, char *buf, int linecount);
